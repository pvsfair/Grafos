 ...
 */
public class TesteGrafico extends Display {
    ...
    public TesteGrafico() {
        ...
        ((PolygonRenderer)polyR).setCurveSlack(1.0f);
        ...
        pan(250, 250);
        setHighQuality(true);
//        addControlListener(new AggregateDragControl());                //DESLIGA O ARRASTAR
    ...
    public static JFrame demo() {
        TesteGrafico ad = new TesteGrafico();
